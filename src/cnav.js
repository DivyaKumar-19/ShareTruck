          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            <MenuItem>
              <Typography textAlign="center">
                <Link to="/clanding" style={{ textDecoration: 'none', color: 'white' }}>Home</Link>
              </Typography>
            </MenuItem>
            <MenuItem>
              <Typography textAlign="center">
                <Link to="/trucksearch" style={{ textDecoration: 'none', color: 'white' }}>Find Ride</Link>
              </Typography>
            </MenuItem>
            <MenuItem>
              <Typography textAlign="center">
                <Link to="/order" style={{ textDecoration: 'none', color: 'white' }}>My Ride</Link>
              </Typography>
            </MenuItem>
            <IconButton
              size="large"
